...
env = MultiAgentGymEnvironment(env_to_load='ma_gym:Checkers-v0')

solver_a2c = MultiAgentGymSolver(env,
                                 create_a2c_policy(env.get_observation_space(), env.get_action_space()))
solver_a2c.perform_training(max_episodes=1000)
solver_a2c.perform_evaluation(max_episodes=100)
